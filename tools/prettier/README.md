...
I mainly use prettier to clean up CSS and HTML sources.
I also use the [Visual Studio Code extension for Prettier](https://github.com/prettier/prettier-vscode).

### Installation - macOS

I installed using the [Homebrew formula](https://formulae.brew.sh/formula/prettier):
